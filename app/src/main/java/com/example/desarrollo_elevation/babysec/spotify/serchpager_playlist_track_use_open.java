...
public class serchpager_playlist_track_use_open
{
    ...
    public interface  CompleteListener{
        ...
        void onComplete(List<PlaylistTrack> items);
    ...
    public serchpager_playlist_track_use_open(SpotifyService spotifyService){mspotify = spotifyService; }
    ...
    private void getData(String query, int offest, final int limit, final CompleteListener listener)
    {
        ...
        mspotify.getPlaylistTracks("desarrollo_elevation", query, options, new SpotifyCallback<Pager<PlaylistTrack>>() {
            @Override
